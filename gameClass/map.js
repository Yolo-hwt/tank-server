//全局变量引入
const { POS, SCREEN, TAGS, PICTURES } = require("../hook/globalParams");
...
module.exports.Map = function () {
	...
	this.homeHit = function (ws) {
		...
		const { homeSize, tileSize, offsetX, offsetY } = this;
		ServerSendMsg(
			ws,
			MSG_TYPE_SERVER.MSG_OPERA_DRAW,
			new DrawMsg('homehit_draw', OPERA_DRAW_TYPE.HOMEHIT_DRAW, { homeSize, tileSize, offsetX, offsetY })
		);
