 ...
 * ..returns
 */
module.exports.Tank = function (gameInstance) {
	this.x = 0;
	this.y = 0;
	this.size = 32;//坦克的大小
 ...
 * ..returns
 */
module.exports.SelectTank = function () {
...
module.exports.PlayTank = function (gameInstance) {
 ...
 * ..returns
 */
module.exports.EnemyOne = function (gameInstance) {
	this.ctx = gameInstance.tankCtx;
	this.gameCtx = gameInstance
	this.isAppear = false;
	this.times = 0;
 ...
 * ..returns
 */
module.exports.EnemyTwo = function (gameInstance) {
	this.ctx = gameInstance.tankCtx;
	this.gameCtx = gameInstance
	this.isAppear = false;
	this.times = 0;
 ...
 * ..returns
 */
module.exports.EnemyThree = function (gameInstance) {
	this.ctx = gameInstance.tankCtx;
	this.gameCtx = gameInstance
	this.isAppear = false;
	this.times = 0;
